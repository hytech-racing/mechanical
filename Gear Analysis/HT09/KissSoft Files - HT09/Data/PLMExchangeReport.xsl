...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/02/xpath-functions" xmlns:xdt="http://www.w3.org/2005/02/xpath-datatypes">
  ...
  <!--   + On January    4th 2013     Objective: Provide a sample to present PLM exchange Report XML                                  -->
  <!--   + On May       15th 2013     Objective: Integrate Mapping information to report and improve metric & Notification display    -->
  <!--   + On January   30th 2014     Objective: Integrate the new attribute File to display PLM briefcase list where object is found -->
  <!--   + On April      9th 2014     Objective: Add support of multi-value for metrics, options & attributes                         -->
  <!--   + On September  9th 2015     Objective: Display attributes associated to notification                                        -->
  <!--   + On December  15th 2015     Objective: Integrate briefcase information My_Briefcase attribute                               -->
  <!--   + On April     1st 2022      Objective: Add a link to downward report when Compatibility Mode is set                         -->
  ...
  <xsl:template match="/">
    ...
    <html>
      ...
      <body link="#0000FF" vlink="#800080" BGCOLOR="white" background="{concat($Instal_Dir,'/resources/graphic/Cke_paterne.gif')}">
        ...
        <head>
          <title>PLM Exchange Report</title>
          <meta name="GENERATOR" content="PLM Exchange Report"/>
        </head>
  ...
  <xsl:template match="Execution">
    ...
    <!-- 1bis- Display link to downward report -->
    ...
    <xsl:if test="$CompatibilityOption='T' and $SplitOption='F'">
      <table border="0">
        <tr>
          <td>
            <h2>Downward compatibility report:</h2>
          </td>
          <td>
            <a href="{$ReportName}_Dw.html">Downward report</a>
          </td>
        </tr>
      </table>
    </xsl:if>
    ...
    <xsl:if test="count(//Object)!=0">
      ...
      <table border="0">
        ...
        <tr>
          ...
          <td>
            <xsl:value-of select="count(//Object[@oper='Created'])"/>
          </td>
        </tr>
        <tr>
          <td>
  ...
  <xsl:template name="Object_Operation_Cell" >
    ...
    <xsl:choose>
      ...
      <xsl:when test="@oper='Synchronize_Create'">
        <td>
          <b>Created</b>
        </td>
      </xsl:when>
      ...
      <xsl:when test="@oper='Synchronize_Delete'">
        <td bgcolor="FF0000">
          <b>Deleted</b>
        </td>
      </xsl:when>
