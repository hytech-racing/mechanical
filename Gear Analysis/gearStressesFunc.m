...
check_sun = AGMA_bs_sun < AGMA_allowable_bs_sun && AGMA_cs_sun < AGMA_allowable_cs_sun;
check_planet1 = AGMA_bs_planet1 < AGMA_allowable_bs_planet1 && AGMA_cs_planet1 < AGMA_allowable_cs_planet1;
check_planet2 = AGMA_bs_planet2 < AGMA_allowable_bs_planet2 && AGMA_cs_planet2 < AGMA_allowable_cs_planet2;
check_ring = AGMA_bs_ring < AGMA_allowable_bs_ring && AGMA_cs_ring < AGMA_allowable_cs_ring;
check_all = AGMA_bs_sun < AGMA_allowable_bs_sun && AGMA_cs_sun < AGMA_allowable_cs_sun && AGMA_bs_planet1 < AGMA_allowable_bs_planet1 && AGMA_cs_planet1 < AGMA_allowable_cs_planet1 && AGMA_bs_planet2 < AGMA_allowable_bs_planet2 && AGMA_cs_planet2 < AGMA_allowable_cs_planet2 && AGMA_bs_ring < AGMA_allowable_bs_ring && AGMA_cs_ring < AGMA_allowable_cs_ring;


results = [check_all, AGMA_allowable_bs_sun, AGMA_bs_sun, AGMA_allowable_cs_sun, AGMA_cs_sun, check_sun];
results = [results, AGMA_allowable_bs_planet1, AGMA_bs_planet1, AGMA_allowable_cs_planet1, AGMA_cs_planet1, check_planet1];
results = [results, AGMA_allowable_bs_planet2, AGMA_bs_planet2, AGMA_allowable_cs_planet2, AGMA_cs_planet2, check_planet2];
results = [results, AGMA_allowable_bs_ring, AGMA_bs_ring, AGMA_allowable_cs_ring, AGMA_cs_ring, check_ring];
