...
gear_ratio = ((n_planet1*n_ring) / (n_planet2*n_sun));

omega_sun = 20000 * (2*pi/60);  %Angular velocity in rad/s (20,000 RPM = max motor speed)
omega_carrier = 0;
omega_planet2 = omega_sun * n_sun/n_planet1;
omega_planet1 = omega_planet2;  %FIX
omega_ring = gear_ratio*omega_sun;
...
cycles_ring = tireRotations;
cycles_carrier = 0;
cycles_sun = (gear_ratio) * cycles_ring;
...
Yn_sun = 3.517*cycles_ring^(-0.0817);	%Bending stress-cycle factor (nitrided steel) (Table 14-14)
Yn_planet1 = 3.517*cycles_ring^(-0.0817);    %Factor, no units
Yn_planet2 = 3.517*cycles_ring^(-0.0817);
Yn_ring = 3.517*cycles_ring^(-0.0817);

Zn_sun = 1.249*cycles_ring^(-0.0138);    %Contact stress-cycle factor (nitrided steel) (Table 14-15)
Zn_planet1 = 1.249*cycles_ring^(-0.0138);    %Factor, no units
Zn_planet2 = 1.249*cycles_ring^(-0.0138);
