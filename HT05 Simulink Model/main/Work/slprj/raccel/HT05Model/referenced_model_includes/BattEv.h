...
typedef struct { int_T ix1vpir2az ; } dmy10bqvs5 ; typedef struct { real_T
hflmlajctv ; } hkgv0zhr3w ; typedef struct { real_T hflmlajctv ; } nvyvwtjtwa
; typedef struct { boolean_T hflmlajctv ; } khjrgybdwv ; typedef struct {
real_T hflmlajctv ; } fr5wy4tsqu ; typedef struct { real_T hflmlajctv ; }
ebrgzbbeqm ; typedef struct { real_T hflmlajctv ; } op3keyawy1 ; struct
a2kiykjvrxh_ { real_T P_0 ; real_T P_1 ; real_T P_2 [ 7 ] ; real_T P_3 [ 101
] ; real_T P_4 [ 6 ] ; real_T P_5 [ 101 ] ; real_T P_6 ; real_T P_7 ; real_T
P_8 [ 42 ] ; real_T P_9 ; real_T P_10 ; uint32_T P_11 [ 2 ] ; } ; struct
bjbjtykkxm { struct SimStruct_tag * _mdlRefSfcnS ; const rtTimingBridge *
...
nw51lwywlm rtb ; dmy10bqvs5 rtdw ; euywnbmp33 rtm ; } lobjb0lvrdo ; extern
