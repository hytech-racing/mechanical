...
typedef struct { real_T phpxvsznk2 ; real_T dvl0jkf022 ; real_T oloygxdfui ;
real_T av3pgj4xc5 ; real_T avllxxcnwp ; real_T gr1c2pn232 ; real_T gswyltq2oj
; real_T pilju15sad ; real_T eoauxnjvso ; real_T lc5in45uon ; real_T
phpxvsznk2_mbvzarwird ; real_T dvl0jkf022_cl54gopm0x ; real_T pw5rfchzym ;
real_T joluo3apal ; real_T do5qvp2gnl ; real_T bfkwritqsm ; real_T
oloygxdfui_kkiq3xxxve ; real_T jmh12knqk4 ; real_T j4an1koocn ; real_T
m4fgfho05f ; real_T bvc4d3rafa ; real_T pdqqh31clo ; real_T j00saob3ud ;
real_T f5vescf5ru ; real_T l1joaocm0k ; real_T bnhtuo4pzv ; real_T ancya45mmo
; real_T fvwphmszym ; real_T hpq3zpwor5 ; real_T emqermn25v ; real_T
cbuxsm4rne ; real_T hddlzs2xkt ; real_T gnsidwdg2i ; boolean_T mv5ovv2sf2 ; }
cx3bhokmct ; typedef struct { real_T hh4vgn0tkn ; real_T n1xqcq4unv ; int_T
...
P_93 ; uint32_T P_94 [ 2 ] ; } ; struct n4bpxhx2nv { struct SimStruct_tag *
...
extern void dwpuxjpomb ( mv4ga5jwa1 * const oczxsqne0n , cx3bhokmct * localB
, cloq5bin3y * localDW , fsi3zxjdsv * localX ) ; extern void fb4yyrugqd (
mv4ga5jwa1 * const oczxsqne0n , cloq5bin3y * localDW , fsi3zxjdsv * localX )
; extern void n5k0o3qutm ( cloq5bin3y * localDW ) ; extern void mfy1r3luh1 (
const real_T * geawchg2qh , cx3bhokmct * localB , cloq5bin3y * localDW ,
a2tgpeokha * localXdis , evfyajgoqu * localXdot ) ; extern void cmnf4xtkyp (
const real_T * cvcsdesmn4 , cx3bhokmct * localB , cloq5bin3y * localDW ,
fsi3zxjdsv * localX , f0can1sh3a * localZCSV ) ; extern void byych5oy3s (
mv4ga5jwa1 * const oczxsqne0n , cloq5bin3y * localDW ) ; extern void
lwglwij1vj ( mv4ga5jwa1 * const oczxsqne0n , cx3bhokmct * localB , cloq5bin3y
* localDW , fsi3zxjdsv * localX ) ; extern void lwglwij1vjTID3 ( void ) ;
extern void MotGenEvDynamic ( mv4ga5jwa1 * const oczxsqne0n , const real_T *
emppsgntig , const real_T * geawchg2qh , const real_T * cvcsdesmn4 , real_T *
fnbywarnx2 , real_T * cg1dw5wgio , cx3bhokmct * localB , cloq5bin3y * localDW
, fsi3zxjdsv * localX ) ; extern void MotGenEvDynamicTID3 ( mv4ga5jwa1 *
const oczxsqne0n , cx3bhokmct * localB , cloq5bin3y * localDW ) ; extern void
kh5ykjtmv0 ( mv4ga5jwa1 * const oczxsqne0n ) ;
#endif
