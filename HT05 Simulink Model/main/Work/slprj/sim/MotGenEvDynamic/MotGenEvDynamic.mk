...
MODEL                = MotGenEvDynamic
MODULES              = MotGenEvDynamic.c MotGenEvDynamic_capi.c c_mexapi_version.c
PRODUCT              = MotGenEvDynamiclib.lib
MAKEFILE             = MotGenEvDynamic.mk
...
MODELLIB                  = MotGenEvDynamiclib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = MotGenEvDynamic_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/MotGenEvDynamic \
