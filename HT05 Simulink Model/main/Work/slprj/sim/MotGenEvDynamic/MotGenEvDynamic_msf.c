...
ssGetOutputPortSignal ( S , 1 ) ; fsi3zxjdsv * localX = ( fsi3zxjdsv * )
ssGetContStates ( S ) ; if ( tid == 0 ) { MotGenEvDynamic ( & ( dw -> rtm ) ,
i_prufec2qzu , i_i_j3lgen1ovj , i_i_cyrwognsi4 , o_B_9_1 , o_B_9_2 , & ( dw
-> rtb ) , & ( dw -> rtdw ) , localX ) ; lwglwij1vj ( & ( dw -> rtm ) , & (
...
4 ] ; ssNonContDerivSigFeedingOutports * mr_nonContOutputArray [ 2 ] ; void *
...
mr_nonContOutputArray [ 1 ] = mr_nonContOutput1 ; cwmdpnrf2r ( S ,
...
ssGetDWork ( S , 0 ) ; n5k0o3qutm ( & ( dw -> rtdw ) ) ; }
...
, o_B_9_2 , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX ) ; } } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { l0vfpqnnodc * dw = (
l0vfpqnnodc * ) ssGetDWork ( S , 0 ) ; fsi3zxjdsv * localX = ( fsi3zxjdsv * )
ssGetContStates ( S ) ; if ( ssIsSampleHit ( S , 0 , tid ) ) { lwglwij1vj ( &
